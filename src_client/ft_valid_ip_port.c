...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/03/05 15:30:37 by amovchan          #+#    #+#             */
/*   Updated: 2018/03/05 15:32:21 by amovchan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_conect(struct hostent *host, struct protoent *prot, int port)
{
	int					sock;
	...
	adrr.sin_addr.s_addr = inet_addr(host->h_name);
...
int			ft_valid_ip_port(char *ip, char *src_port)
{
	...
	return (ft_conect(host, prot, port));
}
